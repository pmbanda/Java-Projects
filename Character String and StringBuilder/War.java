...
{	//declare the global variables 
	...
	private static String compValueCard;
	...
	public static void main(String[] args) 
	{
		...
		String cardValue = returnCardType(playerSuit);

		System.out.println("You have chosen card number " + getValue() + " belonging to suit " + cardValue );//display the results
		System.out.println();
		...
		compValueCard = returnCardType(playerSuit);
	...
	public static String returnCardType(char playerSuit)
		{
			switch(playerSuit)
			{
				case 's':
